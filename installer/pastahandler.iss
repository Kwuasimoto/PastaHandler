; Pasta Handler installer — compile with: iscc /DAppVersion=x.y.z pastahandler.iss
...
[Tasks]
Name: "startup"; Description: "Start Pasta Handler automatically when Windows starts"; Flags: unchecked

[Icons]
; Two front doors, one exe: the tray resident and the settings window
Name: "{autoprograms}\Pasta Handler"; Filename: "{app}\pastahandler.exe"
Name: "{autoprograms}\Pasta Handler Settings"; Filename: "{app}\pastahandler.exe"; Parameters: "--settings"
Name: "{userstartup}\Pasta Handler"; Filename: "{app}\pastahandler.exe"; Tasks: startup

[Run]
Filename: "{app}\pastahandler.exe"; Description: "Launch Pasta Handler now"; Flags: nowait postinstall skipifsilent
