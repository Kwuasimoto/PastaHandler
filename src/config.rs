//! The config file: persistence (TOML, atomic writes, first-run seeding) and
//! the persisted domain structs Config/Snippet. The appearance half of the
//! state lives in theme.rs. This file on disk is also the IPC channel between
//! the resident and settings processes.
